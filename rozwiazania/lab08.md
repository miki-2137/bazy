...
* 1
```sql
SELECT k.nazwa,DATEDIFF(w.data_rozpoczecia,k.dataUr) FROM kreatura k JOIN uczestnicy u ON u.id_uczestnika=k.idKreatury JOIN etapy_wyprawy e ON e.idWyprawy=u.id_wyprawy JOIN wyprawa w ON w.id_wyprawy=u.id_wyprawy WHERE e.sektor=7;
```
